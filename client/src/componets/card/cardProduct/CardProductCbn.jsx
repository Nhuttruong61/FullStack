      ...
      <div className="box-card-product--content">
        ...
        {data?.discount ? (
          <div className="box-card-product--content--monney">
            <p className="box-card-product--content--monney--price">{formatNumber(data?.price)}</p>
          ...
          <div className="box-card-product--content--monney">
            <p className="box-card-product--content--monney--sale">{formatNumber(data?.price)}</p>
          </div>
        )}

        <div className="box-card-product--content--loader">
          <div className="box-card-product--content--loader--color">Còn {data?.quantity}</div>
        </div>
      </div>
    </div>
  );
